//  ClientGameObject - это класс, представляющий собой любой 
//  игровой объект, который может быть отрендерен в игре. 
//  В каждый момент он должен быть привязан к какой-то ячейке.
